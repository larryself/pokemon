...
export const ArrowLeft: FC<SVGProps<SVGSVGElement>> = () => (
  <svg width="35" height="54" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
      <filter id="a" x=".295" y=".908" width="34.039" height="52.23" filterUnits="userSpaceOnUse"
        ...
        <feBlend in2="BackgroundImageFix" result="effect1_dropShadow_1321_6030"/>
        <feBlend in="SourceGraphic" in2="effect1_dropShadow_1321_6030" result="shape"/>
      </filter>
    </defs>
  </svg>);